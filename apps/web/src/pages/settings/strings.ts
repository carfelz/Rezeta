...
export const typesStrings = {
  ...
  createFieldSpecialty: 'Especialidad sugerida',
  createFieldSpecialtyPlaceholder: 'Ej. cardiología, pediatría',
  ...
  editFieldSpecialty: 'Especialidad sugerida',
  editFieldSpecialtyPlaceholder: 'Ej. cardiología, pediatría',
  editSubmit: 'Guardar',
...
export const auditLogStrings = {
  ...
  actionRoleChanged: 'Rol cambiado',
  actionUserInvited: 'Usuario invitado',
  actionUserDeactivated: 'Usuario desactivado',
  actionUserReactivated: 'Usuario reactivado',
