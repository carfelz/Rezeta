...
const ACTION_LABELS: Record<string, string> = {
  ...
  role_changed: auditLogStrings.actionRoleChanged,
  user_invited: auditLogStrings.actionUserInvited,
  user_deactivated: auditLogStrings.actionUserDeactivated,
  user_reactivated: auditLogStrings.actionUserReactivated,
