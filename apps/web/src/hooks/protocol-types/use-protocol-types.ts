...
> {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success(toastStrings.protocolTypeCreated)
    },
    onError: () => {
      toast.error(toastStrings.errorProtocolTypeSave)
    },
  })
}
...
export function useUpdateProtocolType(
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success(toastStrings.protocolTypeUpdated)
    },
    onError: () => {
      toast.error(toastStrings.errorProtocolTypeSave)
    },
...
export function useDeleteProtocolType(): UseMutationResult<void, Error, string> {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      void qc.invalidateQueries({ queryKey: [QK] })
      toast.success(toastStrings.protocolTypeDeleted)
    },
    onError: () => {
      toast.error(toastStrings.errorProtocolTypeSave)
    },
