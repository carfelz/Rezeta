...
export const strings = {
  ...
  EDITOR_PALETTE_HEADER: 'Bloques disponibles',
  EDITOR_HISTORY_VIEW_ALL: 'Ver historial completo',
  EDITOR_ADD_BLOCK_FOOTER: 'Añadir bloque',
  EDITOR_TOC_EMPTY_SECTIONS: 'Sin secciones',
  ...
  EDITOR_PUBLISH_MODAL_CANCEL: 'Cancelar',
  EDITOR_BACK: 'Protocolos',
  EDITOR_VERSION: (n: number) => `v${n}`,
  EDITOR_STATUS_DRAFT: 'Borrador',
  EDITOR_STATUS_ACTIVE: 'Activo',

  // ── Protocols — Editor block controls ─────────────────────────────────────
  EDITOR_BLOCK_EDIT: 'Editar bloque',
  EDITOR_BLOCK_CTX_EDIT: 'Editar',
  EDITOR_BLOCK_CTX_MOVE_UP: 'Mover arriba',
  EDITOR_BLOCK_CTX_MOVE_DOWN: 'Mover abajo',
  EDITOR_BLOCK_CTX_DUPLICATE: 'Duplicar',
  EDITOR_BLOCK_CTX_DELETE: 'Eliminar',
