...
export function CardSubtitle({
  ...
  return (
    <div className={cn('text-[12.5px] font-sans text-n-500 mt-0.5', className)}>{children}</div>
  )
}
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {meta && <div className="text-[12px] font-sans text-n-500 mt-0.5 truncate">{meta}</div>}
      </div>
      {trailing}
    </div>
  )
