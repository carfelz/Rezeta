  ...
  render: () => (
    <div style={{ width: 640 }}>
      <ProtocolBlock type="Sección" title="Indicaciones" onEdit={() => {}} onDelete={() => {}}>
        ...
        >
          Reacción alérgica aguda con compromiso respiratorio o cardiovascular. Signos incluyen
          urticaria, angioedema, estridor, sibilancias o hipotensión.
        </p>
      </ProtocolBlock>
    </div>
  ),
          ...
          steps={[
            {
              id: '1',
              order: 1,
              title: 'Establecer acceso IV',
              detail: 'Calibre grande preferido',
            },
            {
              id: '2',
              order: 2,
              title: 'Oxígeno de alto flujo',
              detail: '15L mascarilla de no reinhalación',
            },
            {
              id: '3',
              order: 3,
              title: 'Monitoreo continuo',
              detail: 'Monitor cardíaco, pulsioxímetro, PA cada 5 min',
            },
          ]}
        />
      </ProtocolBlock>
          ...
          branches={[
            {
              id: 'yes',
              label: 'Sí',
              action: 'Continuar con monitoreo. Repetir epinefrina si recurrencia.',
            },
            {
              id: 'no',
              label: 'No',
              action:
                'Activar código de emergencia. Considerar unidad de cuidados críticos. Segunda dosis de epinefrina IM.',
            },
          ]}
        />
      </ProtocolBlock>
  ...
  render: () => (
    <div style={{ width: 640, display: 'flex', flexDirection: 'column', gap: 12 }}>
      <ProtocolAlert
        severity="warning"
        title="Actuar rápido"
        content="La epinefrina debe administrarse dentro de los 5 minutos del inicio de síntomas para mejores resultados."
      />
      <ProtocolAlert
        severity="danger"
        title="Contraindicación absoluta"
        content="No administrar si el paciente tiene hipersensibilidad conocida a betaagonistas o enfermedad cardiovascular severa."
      />
      <ProtocolAlert
        severity="info"
        content="Documentar cada dosis administrada con hora y respuesta del paciente."
      />
      <ProtocolAlert
        severity="success"
        content="Protocolo validado por Sociedad Dominicana de Medicina de Emergencias, 2026."
      />
    </div>
  ),
}
      ...
      >
        ...
        <ProtocolBlock type="Sección" title="Intervención" required onEdit={() => {}}>
          <ProtocolAlert
            severity="warning"
            title="Actuar rápido"
            content="Epinefrina dentro de los 5 minutos del inicio de síntomas."
          />
